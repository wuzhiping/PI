...
<html>
<head>
  <title>Scada (powered by Mango)</title>
...
<a style="font-size: 13px; color: #414042 font-family: Verdana, Arial, Helvetica, sans-serif;" href="login.htm">Scada (powered by Mango)</a>
</body>
</html>
